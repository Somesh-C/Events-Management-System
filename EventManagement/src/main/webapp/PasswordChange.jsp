        ...
        <div class="main">
            <form action="events" method="POST" id="passwordvalid">
                ...
                <div class="form-group">
                    <label ><i class="fa-solid fa-lock"></i> Enter New Password</label>
                    <input type="password" name="password1" id="pw" placeholder="Enter New Password">
                </div>
                <div class="form-group">
                ...
                <div class="buttons">
                    <button class="save-btn" type="submit" name="PasswordChangeButton">Submit</button>
                </div>
            </form>
        </div>
    </div>
