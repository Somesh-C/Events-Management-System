    ...
    <div class="container">	
        ...
        <div class="main">
                ...
                <div class="form-group">
                    ...
                    <input type="text" value="<%= session.getAttribute("uname") %>" disabled>
                </div>
                <div class="form-group">
                    <label ><i class="fa-solid fa-envelope"></i> Email</label>
                    <input type="email" value="<%= session.getAttribute("umail") %>" disabled>
                </div>
                <div class="form-group">
                    <label ><i class="fa-solid fa-phone"></i> Phone</label>
                    <input type="tel" value="<%= session.getAttribute("uphone") %>" disabled>
                </div>
                <div class="form-group">
                ...
                <div class="buttons">
                    <a href="EditProfile.jsp"><button class="save-btn">Edit Profile</button></a>
                </div>
